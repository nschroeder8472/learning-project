...
Given an integer list, find a peak element and return its index.
...
if __name__ == "__main__":
    # Example usage
    test_arr = [1, 2, 3, 1]
    result = find_peak_element(test_arr)
    print(f"Peak element index in {test_arr}: {result}, value: {test_arr[result]}")
