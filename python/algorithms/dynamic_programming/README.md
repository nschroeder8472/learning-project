...
- Uses recursion with a memo dictionary

#### Tabulation (Bottom-Up)
- Start with smallest subproblems
- Build up solutions iteratively
- Store results in a table (usually a list)
- No recursion needed
...
```bash
pytest python/tests/algorithms/dynamic_programming/ -v
```

Run specific test:
```bash
pytest python/tests/algorithms/dynamic_programming/test_ex1_fibonacci_number.py -v
```
