...
class ex3PostorderTraversalTest {

    private ex3_PostorderTraversal traversal;

    @BeforeEach
    void setUp() {
        traversal = new ex3_PostorderTraversal();
    }

    @Test
    void testEmptyTree() {
        List<Integer> result = traversal.postorder(null);
    ...
    void testNegativeValues() {
        ...
        List<Integer> result = traversal.postorder(root);
        assertEquals(List.of(-10, -2, -5, 2, 10, 5, 0), result);
    }
}
